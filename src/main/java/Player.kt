...
class Player {
  ...
  private val playerState = PlayerState.Walking
  ...
  fun drawSprite() {
    ...
    val vertices: FloatArray = floatArrayOf(
      size * getSpriteWidth().fractionOf(sprite.width) / 2f, size * getSpriteHeight().fractionOf(sprite.height) / 2f, 0.0f,
      1f, 1f, 1f,
      u2, v2,
